...
import pollIntegrationStatus from "@salesforce/apex/ABSLI_IGMSLWCController.getRegistrationComplaintStatuses";
...
export default class Absli_RegisterComplaint extends LightningElement {
    @api recordId;
    @api caseIntId;
    @api intExtId;
    @api selectedAction;
