...
export default class RNWL_RenewalPolicyDetails extends LightningElement {
    ...
    error;
    @track nomineeContacts; nomineesNames; claimsCounts;
    @track maturityDate; policyLapseDate; policyLapsed; policyStartDate; dateOfBirth;
    @track polRenewalNoticeDay;graceEndDate;graceStartDate; 
    @track renewalAPIData; apiType = 'Renewal Check';
    ...
    @wire(getResponseFromFiles, {opportunityId:'$recordId', fileSourceAPI:'Renewal Group Check'})
