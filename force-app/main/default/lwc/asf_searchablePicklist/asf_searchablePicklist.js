...
export default class Asf_searchablePicklist extends LightningElement {
    ...
    */
    ...
    @api callSetAsDisabledField(value) {
        ...
        if (value) {
            //this.selectedValue = '';
            this.formElementClasses = "slds-form-element slds-form-element_horizontal";
            ...
            if (this.required) {
                if (this.multiselect == "true" || this.multiselect == true) {
                    if (this.selectedValues.length < 1) {
                        this.formElementClasses = "slds-form-element slds-form-element_horizontal slds-has-error";
