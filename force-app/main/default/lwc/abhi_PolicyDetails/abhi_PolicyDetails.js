...
import GetPolicyDetails from '@salesforce/apex/ABHI_PolicyDetails.GetPolicyDetails';
import getColumns from '@salesforce/apex/Asf_DmsViewDataTableController.getColumns';
import { getRecord } from 'lightning/uiRecordApi';

export default class Abhi_PolicyDetails extends LightningElement {
    ...
    connectedCallback(){
        getColumns({configName:'ABHI_PolicyDetailsView'})
        .then(result => {
    ...
    GetPolicy(){
        this.isLoading = true;
        GetPolicyDetails({assetId: this.recordId})
        .then(result => {
            this.result=result;
